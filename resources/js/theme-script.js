...
document
    ...
    .setAttribute(
        "data-layout-mode",
        localStorage.getItem("layoutMode") || "light_mode"
    );
document
    .querySelector("html")
    .setAttribute(
        "data-layout-style",
        localStorage.getItem("layoutStyle") || "default"
    );
document
    .querySelector("html")
    .setAttribute(
        "data-nav-color",
        localStorage.getItem("navColor") || "light"
    );
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="status-toggle d-flex align-items-center me-2">
                                        ...
                                        <label for="ltr" class="checktoggles">
                                            <a href="https://dreamspos.dreamstechnologies.com/laravel/template/public/index" traget="_blank"><img src="build/img/theme/theme-img-01.jpg" alt=""></a>
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="status-toggle d-flex align-items-center me-2">
                                        ...
                                        <label for="rtl" class="checktoggles">
                                            <a href="https://dreamspos.dreamstechnologies.com/laravel/template-rtl/public/index" target="_blank"><img src="build/img/theme/theme-img-03.jpg" alt=""></a>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (themeRadio) themeRadio.checked = true;
        ...
        console.error(
            `Theme radio button for value "${savedTheme}" not found.`
        );

    if (layoutRadio) layoutRadio.checked = true;
    else
        console.error(
            `Layout radio button for value "${savedLayout}" not found.`
        );

    if (colorRadio) colorRadio.checked = true;
    else
        console.error(
            `Color radio button for value "${savedColor}" not found.`
        );
