        ...
        <div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
            <aside id="aside" class="ui-aside">
                <ul class="tab nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="tablinks nav-link " href="#messages" id="messages-tab"
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="tablinks nav-link " href="#set2" id="set-tab2" data-bs-toggle="tab"
                            ...
                            <img src="https://dreamspos.dreamstechnologies.com/laravel/template/public/build/../images/svg/calendar.svg"
                                alt="">
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
            ...
            <div class="tab-content tab-content-four pt-2">
                ...
                <ul class="tab-pane " id="document" aria-labelledby="set-tab5">
                    ...
                    <li>
                        <a
                            href="https://dreamspos.dreamstechnologies.com/laravel/template/public/coming-soon"><span>Coming
                                Soon</span> </a>
                    </li>
                    <li>
                        <a
                            href="https://dreamspos.dreamstechnologies.com/laravel/template/public/under-maintenance"><span>Under
                                Maintenance</span> </a>
                    </li>
                </ul>
