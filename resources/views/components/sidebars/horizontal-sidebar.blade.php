        ...
        <ul class="nav">
            <li class="submenu">
                <a href="https://dreamspos.dreamstechnologies.com/laravel/template/public/index"
                    class="active subdrop"><i data-feather="grid"></i><span> Main Menu</span>
                    ...
                    <li class="submenu">
                        ...
                        <ul>
                            ...
                            <li><a href="https://dreamspos.dreamstechnologies.com/laravel/template/public/email"
                                    class="">Email</a></li>
                            <li><a href="https://dreamspos.dreamstechnologies.com/laravel/template/public/todo"
                                    class="">To
                                    Do</a></li>
            ...
            <li class="submenu">
                ...
                <ul>
                    ...
                    <li><a
                            href="https://dreamspos.dreamstechnologies.com/laravel/template/public/add-product"class=""><span>Create
                                Product</span></a></li>
                    <li><a
                            href="https://dreamspos.dreamstechnologies.com/laravel/template/public/expired-products"class=""><span>Expired
                                Products</span></a></li>
                    <li><a
                            href="https://dreamspos.dreamstechnologies.com/laravel/template/public/low-stocks"class=""><span>Low
                                Stocks</span></a></li>
                    <li><a
                            href="https://dreamspos.dreamstechnologies.com/laravel/template/public/category-list"class=""><span>Category</span></a>
                    </li>
                    <li><a
                            href="https://dreamspos.dreamstechnologies.com/laravel/template/public/sub-categories"class=""><span>Sub
                                Category</span></a></li>
                    <li><a
                    ...
                    <li><a
                            href="https://dreamspos.dreamstechnologies.com/laravel/template/public/barcode"class=""><span>Print
                                Barcode</span></a></li>
                    <li><a
                            href="https://dreamspos.dreamstechnologies.com/laravel/template/public/qrcode"class=""><span>Print
                                QR Code</span></a></li>
                </ul>
            </li>
            <li class="submenu">
