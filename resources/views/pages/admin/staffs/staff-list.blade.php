                    ...
                    <div class="table-top table-top-two table-top-new">
                        ...
                        <div class="search-path d-flex align-items-center search-path-new">
                            <div class="d-flex">
                                ...
                                <a href="https://dreamspos.dreamstechnologies.com/laravel/template/public/employees-list"
                                    class="btn-list"><i data-feather="list" class="feather-user"></i></a>
                                <a href="https://dreamspos.dreamstechnologies.com/laravel/template/public/employees-grid"
                                    class="btn-grid active"><i data-feather="grid" class="feather-user"></i></a>
                            </div>
                ...
                <div class="row">
                                ...
                                <div class="profile-head-action">
                                    ...
                                    <div class="dropdown profile-action">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="https://dreamspos.dreamstechnologies.com/laravel/template/public/edit-employee"
                                                    class="dropdown-item"><i data-feather="edit"
                                                        class="info-img"></i>Edit</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);"
                                                    class="dropdown-item confirm-text mb-0"><i data-feather="trash-2"
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info">
                                <div class="profile-pic active-profile">
                                    <img src="https://dreamspos.dreamstechnologies.com/laravel/template/public/build/img/users/user-06.jpg"
                                        alt="">
                                </div>
                                <h5>EMP ID : POS004</h5>
                                <h4>Janet Hembre</h4>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6">
                        <div class="employee-grid-profile">
                            ...
                            <div class="profile-info">
                                <div class="profile-pic active-profile">
                                    <img src="https://dreamspos.dreamstechnologies.com/laravel/template/public/build/img/users/user-07.jpg"
                                        alt="">
                                </div>
                                <h5>EMP ID : POS007</h5>
                                <h4>Susan Moore</h4>
