<x-app-layout>
    <div class="page-wrapper">
        <div class="content">
                    ...
                    <li>
                        <div class="page-btn">
                            <a href="https://dreamspos.dreamstechnologies.com/laravel/template/public/employees-list"
                                class="btn btn-secondary"><i data-feather="arrow-left" class="me-2"></i>Back to Employee
                                List</a>
                        </div>
                    </li>
                    <li>
            ...
            <!-- /product list -->
            <form action="https://dreamspos.dreamstechnologies.com/laravel/template/public/add-employee">
                <div class="card">
                    <div class="card-body">
                        <div class="new-employee-field">
                            <div class="card-title-head">
                                <h6><span><i data-feather="info" class="feather-edit"></i></span>Employee Information
                                </h6>
                            </div>
