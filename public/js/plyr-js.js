  ...
  (function (global, factory) {
    ...
    var controls = {
      ...
      updateProgress: function updateProgress(event) {
        ...
        var setProgress = function setProgress(target, input) {
          ...
          var progress = is.element(target)
            ? target
      ...
      timeUpdate: function timeUpdate(event) {
        ...
        var invert =
          !is.element(this.elements.display.duration) && this.config.invertTime; // Duration
      ...
      inject: function inject() {
        ...
        var insertMethod = is.element(container)
        ...
        function Fullscreen(player) {
          ...
          on.call(
            ...
            function (event) {
              ...
              if (
                is.element(_this2.player.elements.controls) &&
            ...
            },
            {
              ...
              get: function get() {
                ...
                prefixes.some(function (pre) {
                  if (
                    is.function(document["".concat(pre, "ExitFullscreen")]) ||
                    is.function(document["".concat(pre, "CancelFullScreen")])
                  ) {
                    value = pre;
                    return true;
                  }
    ...
    var ui = {
      ...
      setTitle: function setTitle() {
        ...
        if (this.isEmbed) {
          ...
          var title = !is.empty(this.config.title)
            ? this.config.title
            : "video";
          ...
          },
          {
            ...
            value: function controls$$1() {
              ...
              if (
                ...
                !is.element(elements.display.duration)
              ) {
    ...
    var vimeo = {
      ...
      setAspectRatio: function setAspectRatio(input) {
        var _split$map = (is.string(input) ? input : this.config.ratio)
            .split(":")
            .map(Number),
      ...
      ready: function ready$$1() {
        ...
        player.on("enterfullscreen exitfullscreen", function (event) {
          ...
          target.style[dimension] = toggle
            ? "".concat(vimeo.padding, "%")
            : null;
        }); // Rebuild UI
        ...
        _createClass(Ads, [
          {
            ...
            value: function load() {
              ...
              if (this.enabled) {
                ...
                if (
                  !is.object(window.google) ||
                  !is.object(window.google.ima)
                ) {
          ...
          },
          {
            ...
            value: function setupIMA() {
              ...
              this.elements.displayContainer =
                new google.ima.AdDisplayContainer(this.elements.container); // Request video ads to be pre-loaded
